---
title: "Do age and transportation habits predict communication apprehension?"
author: "Tyler Johnston, Vanessa Kountakis, Shivya Paul, Jacob Van Vleet"
date: today
execute:
  warning: false
  message: false
...
```{r echo=FALSE, include=FALSE}
data <- read.csv("C:/Users/ttdog/Projects/groupproject_sibling_data/cleandata/minimal_clean.csv") |> 
  glimpse()
```
...
@fig-predictions shows the predicted versus actual communication apprehension values for each model. Points closer to the diagonal red line indicate better predictions. 
